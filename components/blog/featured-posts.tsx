...
export function FeaturedPosts({ posts, title = "Featured Posts" }: FeaturedPostsProps) {
        ...
        <section className="py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col gap-6">
                    {sidePosts.map((post) => (
                        <article key={post.slug} className="flex-1 group cursor-pointer bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-row lg:flex-col">
                            <Link href={`/${post.category}/${post.slug}`} className="flex w-full h-full">
