                                ...
                                {results.length > 0 ? (
                                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                        {results.map((result, idx) => (
                                            ...
                                            >
                                                <span className="text-xs font-semibold text-blue-600 mb-1 block">{result.category}</span>
                                                <h3 className="text-lg font-bold text-gray-900 group-hover:text-blue-700 mb-2">{result.title}</h3>
