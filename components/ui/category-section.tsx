        ...
        <div className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col space-y-4">
                    {listPosts.map((post) => (
                        <div key={post.slug} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
               ...
               */}
                            <Link href={`${post.categorySlug}/${post.slug}`} className="group block">
                    ...
                    {listPosts.length === 0 && (
                        <p className="text-gray-500 italic">Pronto más artículos en esta sección.</p>
                    )}
                </div>
            </div>
        </div>
