...
export default function EnrutadorPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-[#F8FBFD] p-6 md:p-8 rounded-sm shadow-sm border border-gray-100">
                ...
                >
                  <Button className="bg-[#1EA091] hover:bg-[#168579] text-white font-bold px-6 py-2 rounded-sm">
              ...
              {/* Info Box */}
              <div className="bg-white p-6 md:p-8 rounded-sm border border-gray-200">
                <h3 className="text-[#2F4050] font-bold text-lg mb-4">
                  Mantente informado
                </h3>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              {/* Offer Card */}
              <div className="bg-white rounded-sm shadow-[0_4px_20px_rgba(0,0,0,0.1)] p-6 border border-gray-100 text-center">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <Bell className="text-[#D8AA26] w-6 h-6 fill-current" />
                  <h3 className="text-[#DB2A2A] font-bold text-xl">
                    ¡Oferta por tiempo limitado!
                  </h3>
                </div>

                <h2 className="text-gray-800 font-extrabold text-2xl mb-4 tracking-tight">
                ...
                <Link href="/recomendador-de-tarjetas-de-credito-p2">
                  <Button className="w-full bg-[#DB2A2A] hover:bg-[#B71C1C] text-white font-bold text-lg py-4 rounded-sm shadow-md uppercase tracking-wide">
