...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://topfinanzas.com/mx/soluciones-financieras/requisitos-tarjeta-santander-aeromexico-platinum",
    languages: {
      "es-MX":
        "https://topfinanzas.com/mx/soluciones-financieras/requisitos-tarjeta-santander-aeromexico-platinum",
    },
...
export default function RequisitosTarjetaSantanderAeromexicoPlatinumPage() {
  return (
    <main className="bg-white min-h-screen flex flex-col">
      ...
      <RelatedPosts
        currentSlug="requisitos-tarjeta-santander-aeromexico-platinum"
