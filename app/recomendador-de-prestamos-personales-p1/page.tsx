                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-left text-sm leading-6 text-gray-800 my-8">
                            ...
                            tus finanzas. Te ofrecemos el mejor análisis de préstamos personales
                            y las mejores recomendaciones para que encuentres fácilmente el ideal
                            para ti, ya sea para consolidar deudas, imprevistos o proyectos personales.
                            Explora nuestras recomendaciones y encuentra el préstamo que mejor se adapta a ti.
                        </p>
                        ...
                        <p className="text-left text-sm leading-6 text-gray-800 mb-10">
                            ...
                            simplificar tus finanzas y alcanzar tus objetivos sin complicaciones.
                        </p>
                        ...
                        <div className="mt-8 mb-6 border rounded-lg overflow-hidden">
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    >
                                        ¿Por qué elegir un préstamo sin penalización por pagos anticipados?
                                    </h3>
                                </div>
                            </button>
                            {openFaq === "prepayment" && (
                                ...
                                >
                                    <p className="text-left text-sm">
                                        Un préstamo sin penalización te permite liquidarlo antes de tiempo,
                                        reduciendo intereses y facilitándote salir de deudas rápidamente.
                                    </p>
                                </div>
                            )}
                            ...
                            {openFaq === "selection" && (
                                ...
                                >
                                    <p className="text-left text-sm">
                                        Considera tus objetivos financieros y evalúa factores como tasas de interés,
                                        comisiones y plazos para elegir el préstamo que se ajuste mejor a tus necesidades.
                                    </p>
                                </div>
                            )}
                            ...
                            {openFaq === "debt" && (
                                ...
                                >
                                    <p className="text-left text-sm">
                                        Claro que sí! Consolidar tus deudas en un solo préstamo simplifica los pagos
                                        y te puede ahorrar dinero en intereses a largo plazo.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-10">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-gray-600 leading-tight">
                                    Elige montos y plazos que se ajusten a tu capacidad de pago
