            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <section className="my-6">
                ...
                <ul className="list-disc pl-6 mb-4 text-sm leading-5 font-light text-gray-800">
                  ...
                  <li className="mb-2">
                    <Link
                      href="/soluciones-financieras/lloyds-bank-personal-loan"
                      className="text-blue-600 hover:underline"
                    >
                  ...
                  <li className="mb-2">
                    <Link
                      href="/soluciones-financieras/nationwide-personal-loan"
                      className="text-blue-600 hover:underline"
                    >
                  ...
                  <li className="mb-2">
                    <Link
                      href="/soluciones-financieras/santander-uk-personal-loan"
                      className="text-blue-600 hover:underline"
                    >
