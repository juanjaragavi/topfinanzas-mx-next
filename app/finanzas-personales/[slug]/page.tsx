...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: "Consejos y guías para mejorar tus finanzas personales en México.",
    };
}

export default async function PersonalFinanceDynamicPage({ params }: { params: Promise<{ slug: string }> }) {
    const { slug } = await params;
                        ...
                        <div className="my-8 text-left sm:text-left">
                            ...
                            <section className="my-6">
                                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
                                    Contenido dinámico para el artículo de finanzas personales: {slug}.
                                </p>
                            </section>
