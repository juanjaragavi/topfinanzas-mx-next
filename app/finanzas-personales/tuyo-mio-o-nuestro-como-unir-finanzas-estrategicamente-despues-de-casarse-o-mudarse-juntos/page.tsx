            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <section className="my-6">
                ...
                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
                  ...
                  no tiene que ser complicado. Empiecen por registrar sus
                  ingresos combinados y sus gastos compartidos durante un mes.
                  ...
                  : 50% para necesidades, 30% para deseos y 20% para ahorros y
                  pago de{" "}
                  <Link
                  ...
                  . También hay muchísimas apps que les pueden facilitar este
                  proceso.
                </p>
                <p className="text-left sm:text-left text-gray-800 mb-4 text-sm leading-6 font-light">
