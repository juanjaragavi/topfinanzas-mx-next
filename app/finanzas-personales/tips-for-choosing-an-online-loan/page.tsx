            ...
            <div className="my-8 text-left sm:text-left">
              ...
              <section className="my-6">
                ...
                <p className="text-gray-800 mb-4 text-sm leading-5 font-light">
                  ...
                  <Link
                    href="/soluciones-financieras/revolut-personal-loan"
                  ...
                  ,{" "}
                  <Link
                    href="/soluciones-financieras/monzo-personal-loan"
                    className="text-blue-600 hover:underline"
                  >
                    Monzo
                  </Link>
                  , or{" "}
                  <Link
                    href="/soluciones-financieras/starling-bank-personal-loan"
                    className="text-blue-600 hover:underline"
                  >
                    Starling Bank
                  </Link>
