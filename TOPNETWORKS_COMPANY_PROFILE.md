...
## Repository Context: TopFinanzas MX
...
| Property Positioning | Mexico financial services comparison property focused on Spanish-language credit card, personal loan, and personal finance education content. |

This adaptation is maintained inside the TopFinanzas MX codebase. It should be used as parent-company context when making product, content, analytics, or deployment decisions for the Mexico property.
